...
_screenTransitionState4:
	...
	ld (wLoadedTilesetUniqueGfx),a		; $4341
	xor a			; $4344
...
@state4:
	...
	ld a,(wTilesetUniqueGfx)		; $455d
	ld (wLoadedTilesetUniqueGfx),a		; $4560
	xor a			; $4563
	ld (wTilesetUniqueGfx),a		; $4564
;;
; @addr{4567}
@state5:
...
@state4:
	...
	ld a,(wTilesetUniqueGfx)		; $4650
	ld (wLoadedTilesetUniqueGfx),a		; $4653
	xor a			; $4656
	ld (wTilesetUniqueGfx),a		; $4657
;;
; @addr{465a}
@state5:
...
_determineSeasonForRoomPack:
	...
	ld a,GLOBALFLAG_SEASON_ALWAYS_SPRING		; $7e0d
...
_setSeason:
	...
	; Unused code snipped?
	ld a,GLOBALFLAG_SEASON_ALWAYS_SPRING		; $7e24
...
_setHoronVillageSeason:
	ld a,GLOBALFLAG_SEASON_ALWAYS_SPRING		; $7e2c
...
checkRoomPackAfterWarp_body:
	ld a,GLOBALFLAG_SEASON_ALWAYS_SPRING		; $7e6e
