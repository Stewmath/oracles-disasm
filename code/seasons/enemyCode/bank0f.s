...
enemyCode01:
	...
	ld (hl),$87		; $45c4
	ld a,$09		; $45c6
	jp enemySetAnimation		; $45c8
_label_0f_042:
	ld e,$ba		; $45cb
	ld a,(de)		; $45cd
	or a			; $45ce
	jr z,_label_0f_043	; $45cf
	ld e,$aa		; $45d1
	ld a,(de)		; $45d3
	res 7,a			; $45d4
	sub $1a			; $45d6
	cp $05			; $45d8
	jr nc,_label_0f_043	; $45da
	ld a,$63		; $45dc
	call playSound		; $45de
	ld h,d			; $45e1
	ld l,$ab		; $45e2
...
_label_0f_043:
	call $49b6		; $45ff
	call $498c		; $4602
	call _ecom_getSubidAndCpStateTo08		; $4605
	cp $0c			; $4608
	jr nc,_label_0f_044	; $460a
	rst_jumpTable			; $460c
	dec hl			; $460d
	ld b,(hl)		; $460e
	ld e,b			; $460f
...
_label_0f_044:
	...
	ld a,$01		; $462b
	ld ($cc1c),a		; $462d
	ldh a,(<hActiveObject)	; $4630
	ld d,a			; $4632
	ld bc,$0012		; $4633
	call _enemyBoss_spawnShadow		; $4636
	ret nz			; $4639
	ld a,$3c		; $463a
	call _ecom_setSpeedAndState8		; $463c
	ld l,$86		; $463f
	ld (hl),$08		; $4641
	ld l,$b0		; $4643
	ld (hl),$d2		; $4645
	...
	ld l,$8f		; $464b
	ld (hl),$ff		; $464d
	call objectSetVisible83		; $464f
	ld bc,$2f0b		; $4652
	jp showText		; $4655
	ret			; $4658
	call _ecom_decCounter1		; $4659
	ret nz			; $465c
	ld l,e			; $465d
	inc (hl)		; $465e
	ld l,$a4		; $465f
	set 7,(hl)		; $4661
	call getRandomNumber_noPreserveVars		; $4663
	and $01			; $4666
	ld e,$82		; $4668
	ld (de),a		; $466a
	ld b,a			; $466b
	...
	ld a,b			; $4674
	inc a			; $4675
	call enemySetAnimation		; $4676
	xor a			; $4679
	ld ($cca4),a		; $467a
	ld ($cbca),a		; $467d
	ld a,$33		; $4680
	ld (wActiveMusic),a		; $4682
	jp playSound		; $4685
	ld bc,$4878		; $4688
	ld h,d			; $468b
	ld l,$8b		; $468c
	...
	ldh (<hFF8E),a	; $4693
	call $49a8		; $4695
	jp nc,_ecom_moveTowardPosition		; $4698
	ld l,e			; $469b
	inc (hl)		; $469c
	inc l			; $469d
	ld (hl),$00		; $469e
...
.DB $e3				; $46b5
	...
	ldi (hl),a		; $46b9
	ld b,a			; $46ba
	jr z,_label_0f_047	; $46bb
	call _ecom_decCounter1		; $46bd
	jr z,_label_0f_045	; $46c0
	ld l,$9b		; $46c2
	ld a,(hl)		; $46c4
	xor $03			; $46c5
	ldi (hl),a		; $46c7
...
_label_0f_045:
	...
	ld a,b			; $46de
	inc a			; $46df
	jp enemySetAnimation		; $46e0
	call _ecom_decCounter1		; $46e3
	jr z,_label_0f_046	; $46e6
	ld l,$9b		; $46e8
	ld a,(hl)		; $46ea
	xor $03			; $46eb
	ldi (hl),a		; $46ed
...
_label_0f_046:
	...
	ld a,$01		; $46fc
	ld ($cbca),a		; $46fe
	call fastFadeoutToWhite		; $4701
_label_0f_047:
	ld a,$b9		; $4704
	jp playSound		; $4706
	ld a,$03		; $4709
	ld (de),a		; $470b
	call disableLcd		; $470c
	ld e,$82		; $470f
	ld a,(de)		; $4711
	inc a			; $4712
	ld ($ccc4),a		; $4713
	call func_131f		; $4716
	ld a,$02		; $4719
	call loadGfxRegisterStateIndex		; $471b
	ldh a,(<hActiveObject)	; $471e
	ld d,a			; $4720
	ret			; $4721
	ld a,$04		; $4722
	ld (de),a		; $4724
	jp fadeinFromWhiteWithDelay		; $4725
	ld a,($c4ab)		; $4728
	or a			; $472b
	ret nz			; $472c
	ld h,d			; $472d
...
_label_0f_048:
	...
	inc (hl)		; $4764
_label_0f_049:
	call getRandomNumber		; $4765
	and $0e			; $4768
	ld l,$b6		; $476a
	cp (hl)			; $476c
	jr z,_label_0f_049	; $476d
	ld (hl),a		; $476f
	ld bc,$4783		; $4770
	call addAToBc		; $4773
	ld e,$b7		; $4776
	...
	jr nc,$48		; $4786
	ld b,b			; $4788
	jr nc,_label_0f_052	; $4789
	ld e,b			; $478b
	ld a,b			; $478c
	jr nc,_label_0f_048	; $478d
	ld e,b			; $478f
	ret nz			; $4790
	ld a,b			; $4791
	or b			; $4792
	...
	ld a,(hl)		; $4796
	or a			; $4797
	jr z,_label_0f_050	; $4798
	dec (hl)		; $479a
_label_0f_050:
	ld l,$b7		; $479b
	call _ecom_readPositionVars		; $479d
	call $49a8		; $47a0
	jp nc,_ecom_moveTowardPosition		; $47a3
	ld l,$b3		; $47a6
	ld a,(hl)		; $47a8
	or a			; $47a9
	ld l,$84		; $47aa
	jr z,_label_0f_051	; $47ac
	dec (hl)		; $47ae
	ld l,$bb		; $47af
	ld (hl),$1e		; $47b1
	ret			; $47b3
_label_0f_051:
	...
	ld (hl),$1e		; $47e9
	ld a,$03		; $47eb
	call enemySetAnimation		; $47ed
	call objectGetAngleTowardEnemyTarget		; $47f0
	ld b,a			; $47f3
	call getFreePartSlot		; $47f4
	ret nz			; $47f7
	ld (hl),$4c		; $47f8
	ld l,$c9		; $47fa
	ld (hl),b		; $47fc
	ld bc,$1000		; $47fd
	jp objectCopyPositionWithOffset		; $4800
_label_0f_052:
	call _ecom_decCounter1		; $4803
	jp nz,enemyAnimate		; $4806
	ld (hl),$10		; $4809
	ld l,e			; $480b
	inc (hl)		; $480c
	ld a,$04		; $480d
	jp enemySetAnimation		; $480f
...
_label_0f_053:
	...
	ld (hl),$05		; $483c
	ld a,$07		; $483e
	jp enemySetAnimation		; $4840
	call _ecom_decCounter1		; $4843
	jp nz,enemyAnimate		; $4846
	ld (hl),$14		; $4849
	inc l			; $484b
	dec (hl)		; $484c
	jr z,_label_0f_055	; $484d
	ld a,(hl)		; $484f
	dec a			; $4850
	ld hl,$4871		; $4851
_label_0f_054:
	rst_addDoubleIndex			; $4854
	ldi a,(hl)		; $4855
	ld b,a			; $4856
	ld c,(hl)		; $4857
	call getFreeEnemySlot_uncounted		; $4858
	ret nz			; $485b
	ld (hl),$5e		; $485c
	ld l,$97		; $485e
	ld (hl),d		; $4860
	dec l			; $4861
	ld (hl),$80		; $4862
	jp objectCopyPositionWithOffset		; $4864
_label_0f_055:
	dec l			; $4867
	ld (hl),$b4		; $4868
	ld l,e			; $486a
	inc (hl)		; $486b
	ld a,$03		; $486c
	jp enemySetAnimation		; $486e
	nop			; $4871
	jr nz,_label_0f_054	; $4872
	nop			; $4874
	nop			; $4875
	ld ($ff00+$20),a	; $4876
	nop			; $4878
	call _ecom_decCounter1		; $4879
	ret nz			; $487c
	jr _label_0f_053		; $487d
	ld a,(de)		; $487f
	sub $0c			; $4880
	rst_jumpTable			; $4882
	adc l			; $4883
	...
	ld l,$b9		; $4896
	ld (hl),$01		; $4898
	call getRandomNumber_noPreserveVars		; $489a
	and $01			; $489d
	ld e,$b5		; $489f
	ld (de),a		; $48a1
	ld e,$b4		; $48a2
	...
	cp $02			; $48a5
	ld a,$03		; $48a7
	jr nc,_label_0f_056	; $48a9
	inc a			; $48ab
_label_0f_056:
	ld e,$87		; $48ac
	ld (de),a		; $48ae
	ld a,$05		; $48af
	jp enemySetAnimation		; $48b1
	inc e			; $48b4
	ld a,(de)		; $48b5
	rst_jumpTable			; $48b6
	cp e			; $48b7
	...
	ld a,(de)		; $48b9
	ld c,c			; $48ba
	call _ecom_decCounter1		; $48bb
	jp nz,enemyAnimate		; $48be
	ld (hl),$1e		; $48c1
	inc l			; $48c3
	dec (hl)		; $48c4
	jr z,_label_0f_059	; $48c5
	ld b,(hl)		; $48c7
	dec b			; $48c8
	ld l,$b4		; $48c9
	ld a,(hl)		; $48cb
	cp $02			; $48cc
	ld hl,$4912		; $48ce
	jr nc,_label_0f_057	; $48d1
	ld hl,$4906		; $48d3
_label_0f_057:
	ld a,b			; $48d6
	add a			; $48d7
	rst_addDoubleIndex			; $48d8
	ldi a,(hl)		; $48d9
	ld b,a			; $48da
	ldi a,(hl)		; $48db
	ld c,a			; $48dc
	...
	ld a,(de)		; $48df
	or a			; $48e0
	jr z,_label_0f_058	; $48e1
	inc hl			; $48e3
_label_0f_058:
	ld e,(hl)		; $48e4
	call getFreeEnemySlot_uncounted		; $48e5
	ret nz			; $48e8
	ld (hl),$5d		; $48e9
	ld l,$89		; $48eb
	ld (hl),e		; $48ed
	...
	inc l			; $48f2
	ld (hl),d		; $48f3
	jp objectCopyPositionWithOffset		; $48f4
_label_0f_059:
	ld l,e			; $48f7
	inc (hl)		; $48f8
	ld l,$86		; $48f9
...
_label_0f_060:
	...
	ld h,d			; $4933
	ld l,$b7		; $4934
	call _ecom_readPositionVars		; $4936
	call $49a8		; $4939
	jp nc,_ecom_moveTowardPosition		; $493c
	ld l,$84		; $493f
	inc (hl)		; $4941
	inc l			; $4942
	ld (hl),$00		; $4943
	...
	ld (hl),$01		; $494a
	ld a,$08		; $494c
	call enemySetAnimation		; $494e
	call getFreePartSlot		; $4951
	ret nz			; $4954
	ld (hl),$4e		; $4955
	ld bc,$e800		; $4957
	jp objectCopyPositionWithOffset		; $495a
	inc e			; $495d
	ld a,(de)		; $495e
	rst_jumpTable			; $495f
	ld h,h			; $4960
	...
	ld (hl),e		; $4962
	ld c,c			; $4963
	call _ecom_decCounter1		; $4964
	jp nz,enemyAnimate		; $4967
	ld (hl),$3c		; $496a
	ld l,e			; $496c
	inc (hl)		; $496d
	ld a,$06		; $496e
	jp enemySetAnimation		; $4970
	call _ecom_decCounter1		; $4973
	ret nz			; $4976
	ld l,$84		; $4977
	ld (hl),$0e		; $4979
	ld l,$86		; $497b
	...
	ld (hl),$00		; $4985
	ld a,$02		; $4987
	jp enemySetAnimation		; $4989
	ld a,(wFrameCounter)		; $498c
	and $03			; $498f
	ret nz			; $4991
	ld h,d			; $4992
	ld l,$b0		; $4993
...
_label_0f_061:
	...
	inc hl			; $49dd
	ld c,d			; $49de
	jr nc,_label_0f_064	; $49df
	ld a,($cca4)		; $49e1
	or a			; $49e4
	jr nz,_label_0f_062	; $49e5
	ld a,($cc34)		; $49e7
	or a			; $49ea
	ret nz			; $49eb
	inc a			; $49ec
	ld ($cbca),a		; $49ed
	ld ($cca4),a		; $49f0
	call clearAllParentItems		; $49f3
_label_0f_062:
	call _ecom_flickerVisibility		; $49f6
	call _ecom_decCounter1		; $49f9
	jr z,_label_0f_063	; $49fc
	ld a,(hl)		; $49fe
	cp $61			; $49ff
	ret nc			; $4a01
	and $0f			; $4a02
...
_label_0f_063:
	...
	ld l,$85		; $4a0a
	inc (hl)		; $4a0c
	call _ecom_decCounter1		; $4a0d
	jp nz,_ecom_flickerVisibility		; $4a10
	ld l,e			; $4a13
	inc (hl)		; $4a14
	ld l,$9b		; $4a15
	xor a			; $4a17
...
_label_0f_064:
	...
	add (hl)		; $4a42
	ld c,a			; $4a43
	call getFreeInteractionSlot		; $4a44
	ret nz			; $4a47
	ld (hl),$56		; $4a48
	ld l,$4b		; $4a4a
	ld (hl),b		; $4a4c
