...
_label_0a_213:
	...
	ld e,$48		; $60a7
	ld a,(de)		; $60a9
	call interactionSetAnimation		; $60aa
	jp objectSetVisible82		; $60ad
	add hl,bc		; $60b0
	rrca			; $60b1
	add hl,bc		; $60b2
	rla			; $60b3
	...
	ld l,$4b		; $60be
	cp (hl)			; $60c0
	jr nc,_label_0a_214	; $60c1
	jp objectApplySpeed		; $60c3
_label_0a_214:
	ld a,(de)		; $60c6
	ld (hl),a		; $60c7
	jp $63d5		; $60c8
	...
	ld l,$73		; $60cf
	cp (hl)			; $60d1
	jr nc,_label_0a_215	; $60d2
	ld l,$50		; $60d4
	ld b,(hl)		; $60d6
	ld c,$08		; $60d7
	ld a,($ccb0)		; $60d9
	cp d			; $60dc
	call z,updateLinkPositionGivenVelocity		; $60dd
	jp objectApplySpeed		; $60e0
_label_0a_215:
	ld a,(hl)		; $60e3
	ld (de),a		; $60e4
	jp $63d5		; $60e5
	...
	ld l,$72		; $60ec
	cp (hl)			; $60ee
	jr nc,_label_0a_216	; $60ef
	ld l,$50		; $60f1
	ld b,(hl)		; $60f3
	ld c,$10		; $60f4
	ld a,($ccb0)		; $60f6
	cp d			; $60f9
	call z,updateLinkPositionGivenVelocity		; $60fa
	jp objectApplySpeed		; $60fd
_label_0a_216:
	ld a,(hl)		; $6100
	ld (de),a		; $6101
	jp $63d5		; $6102
	...
	ld l,$4d		; $6109
	cp (hl)			; $610b
	jr nc,_label_0a_217	; $610c
	ld l,$50		; $610e
	ld b,(hl)		; $6110
	ld c,$18		; $6111
	ld a,($ccb0)		; $6113
	cp d			; $6116
	call z,updateLinkPositionGivenVelocity		; $6117
	jp objectApplySpeed		; $611a
_label_0a_217:
	ld a,(de)		; $611d
	ld (hl),a		; $611e
	jp $63d5		; $611f
...
_label_0a_218:
	...
	ld e,$48		; $615b
	ld a,(de)		; $615d
	call interactionSetAnimation		; $615e
	jp objectSetVisible82		; $6161
	ld e,$72		; $6164
	ld a,(de)		; $6166
	ld h,d			; $6167
	ld l,$4b		; $6168
	cp (hl)			; $616a
	jr c,_label_0a_220	; $616b
	ld a,(de)		; $616d
	ld (hl),a		; $616e
	jp $63d5		; $616f
	ld e,$4d		; $6172
	...
	ld l,$72		; $6184
	cp (hl)			; $6186
	jr nc,_label_0a_219	; $6187
	ld l,$50		; $6189
	ld b,(hl)		; $618b
	ld c,$10		; $618c
	ld a,($ccb0)		; $618e
	cp d			; $6191
	call z,updateLinkPositionGivenVelocity		; $6192
	jr _label_0a_220		; $6195
_label_0a_219:
	ld a,(hl)		; $6197
	ld (de),a		; $6198
	jp $63d5		; $6199
	...
	ld l,$4d		; $61a0
	cp (hl)			; $61a2
	jr c,_label_0a_220	; $61a3
	ld a,(de)		; $61a5
	ld (hl),a		; $61a6
	jp $63d5		; $61a7
_label_0a_220:
	call objectApplySpeed		; $61aa
	ld a,($ccb0)		; $61ad
	cp d			; $61b0
	ret nz			; $61b1
	ld e,$49		; $61b2
...
_label_0a_221:
	...
	inc e			; $6205
	ld (de),a		; $6206
	call interactionInitGraphics		; $6207
	ld e,$42		; $620a
	ld a,(de)		; $620c
	cp $02			; $620d
	jp z,objectSetVisible83		; $620f
	ret			; $6212
	inc b			; $6213
	inc a			; $6214
	inc bc			; $6215
	...
	ret			; $6222
	call $63a7		; $6223
	jr nz,_label_0a_222	; $6226
	ld (hl),$96		; $6228
	ld l,e			; $622a
	inc (hl)		; $622b
	jp objectSetInvisible		; $622c
_label_0a_222:
	ld e,$5a		; $622f
	ld a,(de)		; $6231
	xor $80			; $6232
	...
	jp playSound		; $623c
	call $63a7		; $623f
	jr nz,_label_0a_222	; $6242
	ld (hl),$78		; $6244
	ld l,e			; $6246
	ld (hl),$01		; $6247
	jp objectSetVisible83		; $6249
	ld a,($d004)		; $624c
	cp $01			; $624f
	ret nz			; $6251
	call objectCheckCollidedWithLink		; $6252
	ret nc			; $6255
	call $62dd		; $6256
	jr c,_label_0a_223	; $6259
	call $630b		; $625b
	jp z,$63bd		; $625e
	call $62a8		; $6261
	ret c			; $6264
	...
	cp b			; $626c
	ld c,$00		; $626d
	jr nc,_label_0a_226	; $626f
	ld c,$10		; $6271
	jr _label_0a_226		; $6273
_label_0a_223:
	call $632a		; $6275
	ld a,(hl)		; $6278
	or a			; $6279
	...
	ld a,($ccb0)		; $6281
	cp d			; $6284
	jr nz,_label_0a_224	; $6285
	ldh a,(<hFF8B)	; $6287
	cp $03			; $6289
	jr z,_label_0a_224	; $628b
	push af			; $628d
	call $63af		; $628e
	pop af			; $6291
	rrca			; $6292
	jr _label_0a_225		; $6293
_label_0a_224:
	ld e,$4d		; $6295
	ld a,(de)		; $6297
	ld b,a			; $6298
...
_label_0a_225:
	ld c,$08		; $629d
	jr nc,_label_0a_226	; $629f
	ld c,$18		; $62a1
_label_0a_226:
	ld b,$14		; $62a3
	jp updateLinkPositionGivenVelocity		; $62a5
	ld h,d			; $62a8
	ld l,$66		; $62a9
	ld a,(hl)		; $62ab
	ld b,a			; $62ac
...
_label_0a_229:
	...
	sub $04			; $631c
	ld b,a			; $631e
	call getTileCollisionsAtPosition		; $631f
	ret nz			; $6322
	ld a,b			; $6323
	add $08			; $6324
	ld b,a			; $6326
	jp getTileCollisionsAtPosition		; $6327
	ld h,d			; $632a
	ld l,$4b		; $632b
	ld a,($d00b)		; $632d
	cp (hl)			; $6330
	ld b,$fa		; $6331
	jr c,_label_0a_230	; $6333
	ld b,$09		; $6335
_label_0a_230:
	add b			; $6337
	ld b,a			; $6338
	...
	sub $03			; $633c
	ld c,a			; $633e
	call getTileCollisionsAtPosition		; $633f
	ld hl,$ff8b		; $6342
	ld (hl),$00		; $6345
	jr z,_label_0a_231	; $6347
	set 1,(hl)		; $6349
_label_0a_231:
	ld a,c			; $634b
	add $05			; $634c
	ld c,a			; $634e
	call getTileCollisionsAtPosition		; $634f
	ld hl,$ff8b		; $6352
	ret z			; $6355
	inc (hl)		; $6356
	ret			; $6357
	call objectCheckCollidedWithLink		; $6358
	jr nc,_label_0a_233	; $635b
	ld h,d			; $635d
	ld l,$4b		; $635e
	ld a,(hl)		; $6360
	ld l,$66		; $6361
	...
	ld a,($d00b)		; $6367
	cp b			; $636a
	jr nc,_label_0a_233	; $636b
	call $62dd		; $636d
	jr nc,_label_0a_233	; $6370
	ld e,$74		; $6372
	ld a,(de)		; $6374
	or a			; $6375
	jr nz,_label_0a_232	; $6376
	ld a,$01		; $6378
	ld (de),a		; $637a
	call $63dd		; $637b
_label_0a_232:
