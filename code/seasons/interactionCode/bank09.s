interactionCode60:
	...
	ld hl,$463f		; $4011
	ld e,$15		; $4014
	call interBankCall		; $4016
	ld a,$06		; $4019
	call objectSetCollideRadius		; $401b
	ld l,$78		; $401e
	ld a,(hl)		; $4020
	or a			; $4021
	jr z,_label_09_000	; $4022
	cp $ff			; $4024
	jr z,_label_09_000	; $4026
	ld l,$74		; $4028
	ld (hl),a		; $402a
_label_09_000:
	call interactionInitGraphics		; $402b
	ld e,$71		; $402e
	ld a,(de)		; $4030
	or a			; $4031
	ret nz			; $4032
	jp objectSetVisiblec2		; $4033
	ld e,$71		; $4036
	ld a,(de)		; $4038
	rst_jumpTable			; $4039
	ld c,b			; $403a
...
_label_09_001:
	...
	call $431a		; $4050
	jp c,$40e2		; $4053
	jp objectSetVisiblec2		; $4056
	ld e,$45		; $4059
	ld a,(de)		; $405b
	or a			; $405c
	jr nz,_label_09_002	; $405d
	ld a,$01		; $405f
	ld (de),a		; $4061
	ld e,$46		; $4062
	ld a,$1e		; $4064
	ld (de),a		; $4066
	call objectCreatePuff		; $4067
	ret nz			; $406a
_label_09_002:
	call interactionDecCounter1		; $406b
	ret nz			; $406e
	jr _label_09_001		; $406f
	ld e,$45		; $4071
	ld a,(de)		; $4073
	rst_jumpTable			; $4074
	ld a,e			; $4075
	...
	ld a,$4d		; $4083
	jp playSound		; $4085
	call interactionDecCounter1		; $4088
	ret nz			; $408b
	ld (hl),$02		; $408c
	inc l			; $408e
	ld (hl),$02		; $408f
	ld l,$45		; $4091
	inc (hl)		; $4093
	call objectGetZAboveScreen		; $4094
	ld h,d			; $4097
	ld l,$4f		; $4098
	ld (hl),a		; $409a
	call objectSetVisiblec0		; $409b
	jp $40d9		; $409e
	call $431a		; $40a1
	jr c,_label_09_005	; $40a4
	call $40d9		; $40a6
	ld c,$10		; $40a9
	call objectUpdateSpeedZ_paramC		; $40ab
	ret nz			; $40ae
	call objectCheckIsOnHazard		; $40af
	jr nc,_label_09_003	; $40b2
	dec a			; $40b4
	jr z,_label_09_007	; $40b5
	jp objectReplaceWithFallingDownHoleInteraction		; $40b7
_label_09_003:
	ld e,$70		; $40ba
	ld a,(de)		; $40bc
	cp $30			; $40bd
	...
	call interactionDecCounter1		; $40c4
	jr z,_label_09_004	; $40c7
	ld bc,$ff56		; $40c9
	jp objectSetSpeedZ		; $40cc
_label_09_004:
	call objectSetVisible		; $40cf
	call objectSetVisiblec2		; $40d2
	ld a,$02		; $40d5
	jr _label_09_006		; $40d7
	call objectCheckWithinScreenBoundary		; $40d9
	jp nc,objectSetInvisible		; $40dc
	jp objectSetVisible		; $40df
_label_09_005:
	call $42c4		; $40e2
	ld a,$03		; $40e5
_label_09_006:
...
_label_09_007:
	...
	res 7,(hl)		; $4102
	ld b,$03		; $4104
	jp objectCreateInteractionWithSubid00		; $4106
	ld a,$80		; $4109
	ld ($cc81),a		; $410b
	ld e,$45		; $410e
	ld a,(de)		; $4110
	rst_jumpTable			; $4111
	jr _label_09_008		; $4112
	inc l			; $4114
	ld b,c			; $4115
	ld b,d			; $4116
	ld b,c			; $4117
	...
	ld l,$46		; $4125
	ld (hl),$20		; $4127
	jp objectSetVisible80		; $4129
	call objectApplySpeed		; $412c
	call interactionDecCounter1		; $412f
	ret nz			; $4132
	ld l,$45		; $4133
	inc (hl)		; $4135
	ld l,$79		; $4136
...
_label_09_008:
	...
	ret nz			; $416f
	call interactionIncState2		; $4170
	call objectSetVisible80		; $4173
	call $42c4		; $4176
	ld bc,$8100		; $4179
	call $4231		; $417c
	ld a,$4c		; $417f
	...
	ld ($cbca),a		; $418b
	ld ($cca4),a		; $418e
	jp interactionDelete		; $4191
	call $431a		; $4194
	ret nc			; $4197
	ld a,($cc78)		; $4198
	bit 7,a			; $419b
	ret z			; $419d
	call objectSetVisible82		; $419e
	call $42c4		; $41a1
	ld a,$4c		; $41a4
	call playSound		; $41a6
	ld a,$03		; $41a9
	...
	ld a,$01		; $41b8
	ld (de),a		; $41ba
	call objectGetShortPosition		; $41bb
	ld ($ccc5),a		; $41be
	ret			; $41c1
	ld a,($cd00)		; $41c2
	and $0c			; $41c5
	jp nz,interactionDelete		; $41c7
	ld a,($ccc5)		; $41ca
	inc a			; $41cd
	ret nz			; $41ce
	ld bc,$ff00		; $41cf
	call objectSetSpeedZ		; $41d2
	ld l,$45		; $41d5
	inc (hl)		; $41d7
	ld a,($d008)		; $41d8
	swap a			; $41db
	...
	ld l,$50		; $41e1
	ld (hl),$14		; $41e3
	jp objectSetVisiblec2		; $41e5
	call objectCheckTileCollision_allowHoles		; $41e8
	call nc,objectApplySpeed		; $41eb
	ld c,$10		; $41ee
	call objectUpdateSpeedZAndBounce		; $41f0
	ret nz			; $41f3
	push af			; $41f4
	call objectReplaceWithAnimationIfOnHazard		; $41f5
	pop bc			; $41f8
	jp c,interactionDelete		; $41f9
	ld a,$77		; $41fc
	call playSound		; $41fe
	bit 4,c			; $4201
	ret z			; $4203
	jp $40cf		; $4204
	call returnIfScrollMode01Unset		; $4207
	call $431a		; $420a
	ret nc			; $420d
	jp $40e2		; $420e
	ld e,$72		; $4211
	...
	ld b,d			; $4220
	ld bc,$80fc		; $4221
	jr _label_09_009		; $4224
	ld bc,$8100		; $4226
_label_09_009:
	ld e,$45		; $4229
	ld a,(de)		; $422b
	or a			; $422c
	jr nz,_label_09_010	; $422d
	inc a			; $422f
	ld (de),a		; $4230
	ld a,$04		; $4231
	ld ($cc6a),a		; $4233
	...
	ld hl,$d000		; $423f
	ld b,$f2		; $4242
	call objectTakePositionWithOffset		; $4244
	call objectSetVisible80		; $4247
	ld a,$4c		; $424a
	call playSound		; $424c
_label_09_010:
	call retIfTextIsActive		; $424f
	ld hl,$cca4		; $4252
	res 0,(hl)		; $4255
	ld a,$0f		; $4257
	ld ($cc85),a		; $4259
	jp interactionDelete		; $425c
	ld a,$78		; $425f
	ld ($cc85),a		; $4261
	ld e,$45		; $4264
	ld a,(de)		; $4266
	...
	ld ($cca4),a		; $4279
	ld a,$ff		; $427c
	call setLinkForceStateToState08_withParam		; $427e
	ld hl,$cc6a		; $4281
	jp objectSetInvisible		; $4284
	call interactionDecCounter1		; $4287
	ret nz			; $428a
	ld l,$45		; $428b
	inc (hl)		; $428d
	ld a,$ff		; $428e
	...
	sub $04			; $42ab
	ld (de),a		; $42ad
	call objectSetVisible		; $42ae
	call objectSetVisible80		; $42b1
	call interactionIncState2		; $42b4
	ld a,$ab		; $42b7
	jp playSound		; $42b9
	ld a,($cca4)		; $42bc
	or a			; $42bf
	ret nz			; $42c0
	jp interactionDelete		; $42c1
	ld e,$74		; $42c4
	ld a,(de)		; $42c6
	ld c,a			; $42c7
	ld e,$70		; $42c8
	...
	ld b,a			; $42cb
	cp $37			; $42cc
	jr nz,_label_09_012	; $42ce
	ld a,$26		; $42d0
	call cpActiveRing		; $42d2
	jr z,_label_09_011	; $42d5
	ld a,$27		; $42d7
	call cpActiveRing		; $42d9
	jr nz,_label_09_012	; $42dc
_label_09_011:
	inc c			; $42de
_label_09_012:
	ld a,b			; $42df
	call giveTreasure		; $42e0
	ld b,a			; $42e3
	ld e,$72		; $42e4
	ld a,(de)		; $42e6
	cp $03			; $42e7
	jr z,_label_09_013	; $42e9
	ld a,b			; $42eb
	call playSound		; $42ec
_label_09_013:
	ld e,$75		; $42ef
...
_label_09_015:
	...
	ld a,($d004)		; $4324
	cp $01			; $4327
	jr z,_label_09_016	; $4329
	cp $08			; $432b
	jr nz,_label_09_017	; $432d
_label_09_016:
	ld a,($cc48)		; $432f
	rrca			; $4332
	jr c,_label_09_017	; $4333
	ld e,$6a		; $4335
	ld a,(de)		; $4337
	or a			; $4338
...
interactionCode6f:
	...
	bit 5,(hl)		; $4358
	jr nz,_label_09_018	; $435a
	ld a,$49		; $435c
	call checkTreasureObtained		; $435e
	jr c,_label_09_018	; $4361
	ld a,$04		; $4363
...
interactionCode78:
	...
	ld a,(de)		; $4434
	ld hl,$4448		; $4435
	rst_addDoubleIndex			; $4438
	ld e,$42		; $4439
	ld a,(de)		; $443b
	and b			; $443c
	jr z,_label_09_019	; $443d
	inc hl			; $443f
_label_09_019:
	ld e,$4b		; $4440
	ld a,(de)		; $4442
...
interactionCode79:
	...
	and $1f			; $4490
	ld (de),a		; $4492
	call interactionInitGraphics		; $4493
	ld e,$50		; $4496
	ld a,$14		; $4498
	ld (de),a		; $449a
	ld e,$42		; $449b
	...
	ld hl,$4680		; $44a9
	ld e,$15		; $44ac
	call interBankCall		; $44ae
	ld hl,$469d		; $44b1
	ld e,$15		; $44b4
	call interBankCall		; $44b6
	jp objectSetVisible83		; $44b9
	ld ($1008),sp		; $44bc
	ld ($0818),sp		; $44bf
	ld ($0810),sp		; $44c2
	jr _label_09_020		; $44c5
	stop			; $44c7
	ld a,($ccb0)		; $44c8
	cp d			; $44cb
	jr z,_label_09_021	; $44cc
	or a			; $44ce
	jr nz,_label_09_022	; $44cf
	call $44ed		; $44d1
	jr nc,_label_09_022	; $44d4
	ld a,d			; $44d6
_label_09_020:
	ld ($ccb0),a		; $44d7
	jr _label_09_022		; $44da
_label_09_021:
	call $44ed		; $44dc
	jr c,_label_09_022	; $44df
	xor a			; $44e1
	ld ($ccb0),a		; $44e2
_label_09_022:
	ld e,$45		; $44e5
	...
	inc l			; $44f4
	ld c,(hl)		; $44f5
	jp interactionCheckContainsPoint		; $44f6
_label_09_023:
	call interactionDecCounter1		; $44f9
	ret nz			; $44fc
	ld hl,$469d		; $44fd
	ld e,$15		; $4500
	call interBankCall		; $4502
	ret			; $4505
	ld a,($cca7)		; $4506
	or a			; $4509
	ret nz			; $450a
	call objectApplySpeed		; $450b
	ld a,($ccb0)		; $450e
	cp d			; $4511
	jr nz,_label_09_023	; $4512
	ld a,($d004)		; $4514
	cp $01			; $4517
	jr nz,_label_09_023	; $4519
	ld e,$50		; $451b
	ld a,(de)		; $451d
	ld b,a			; $451e
	ld e,$49		; $451f
...
interactionCode7a:
	...
	ld a,$01		; $4535
	ld (de),a		; $4537
	call interactionInitGraphics		; $4538
	ld h,d			; $453b
	ld l,$42		; $453c
	ld a,(hl)		; $453e
	add $02			; $453f
	...
	ld l,$70		; $4559
	ld (hl),a		; $455b
	call objectSetVisible83		; $455c
	call $46b0		; $455f
	jr c,_label_09_026	; $4562
_label_09_024:
	ld h,d			; $4564
	ld l,$71		; $4565
	ld (hl),$1e		; $4567
_label_09_025:
	...
	cp b			; $457a
	ld bc,$0008		; $457b
	jr nc,_label_09_029	; $457e
	ld bc,$0118		; $4580
	jr _label_09_029		; $4583
_label_09_026:
	ld h,d			; $4585
	ld l,$66		; $4586
	ld a,(hl)		; $4588
	...
	add b			; $4596
	cp c			; $4597
	jr nc,_label_09_024	; $4598
	ld a,($cc47)		; $459a
	cp $08			; $459d
	ld bc,$0008		; $459f
	jr z,_label_09_027	; $45a2
	cp $18			; $45a4
	ld bc,$0118		; $45a6
	jr nz,_label_09_024	; $45a9
_label_09_027:
	ld a,$01		; $45ab
	ld ($cc81),a		; $45ad
	ld a,($cc7f)		; $45b0
	...
	rrca			; $45b7
	cp c			; $45b8
	jr z,_label_09_028	; $45b9
	ld hl,$c680		; $45bb
	ld a,$16		; $45be
	cp (hl)			; $45c0
	jr z,_label_09_024	; $45c1
	inc hl			; $45c3
	cp (hl)			; $45c4
	jr z,_label_09_024	; $45c5
	ld a,($cc7f)		; $45c7
	or a			; $45ca
	jr nz,_label_09_024	; $45cb
	ld a,($cc77)		; $45cd
	or a			; $45d0
	jr nz,_label_09_024	; $45d1
	ld h,d			; $45d3
	ld l,$71		; $45d4
	dec (hl)		; $45d6
...
_label_09_028:
	...
	call $4672		; $45e3
	jp nz,$4564		; $45e6
	call interactionDecCounter1		; $45e9
	ret nz			; $45ec
_label_09_029:
	ld l,$44		; $45ed
	inc (hl)		; $45ef
	...
	add a			; $45f6
	add b			; $45f7
	call interactionSetAnimation		; $45f8
	ld hl,$ccee		; $45fb
	set 6,(hl)		; $45fe
...
_label_09_031:
	...
	ld a,($d033)		; $4629
	cp $53			; $462c
	jr z,_label_09_033	; $462e
	cp $ac			; $4630
	jr z,_label_09_033	; $4632
	cp $33			; $4634
	jr z,_label_09_033	; $4636
	cp $c3			; $4638
	jr z,_label_09_033	; $463a
	cp $cc			; $463c
	jr z,_label_09_033	; $463e
	cp $3c			; $4640
	jr z,_label_09_033	; $4642
	call $46b0		; $4644
	ld a,($d033)		; $4647
	and $0f			; $464a
	ret z			; $464c
...
_label_09_032:
	...
	ret nz			; $465c
	ld b,$28		; $465d
	jp updateLinkPositionGivenVelocity		; $465f
_label_09_033:
	ld a,($d004)		; $4662
	cp $01			; $4665
	ret nz			; $4667
...
_label_09_037:
	...
	ld l,$4b		; $46f3
	ld a,(hl)		; $46f5
	call setShortPosition		; $46f6
	call interactionInitGraphics		; $46f9
	ld hl,$49bc		; $46fc
	call interactionSetScript		; $46ff
	call objectSetVisible82		; $4702
	ld bc,$7d02		; $4705
	call objectCreateInteraction		; $4708
	ret nz			; $470b
	ld l,$56		; $470c
	ld (hl),d		; $470e
	ret			; $470f
	...
	ld a,($cc77)		; $4713
	or a			; $4716
	jr nz,_label_09_038	; $4717
	bit 4,(hl)		; $4719
	jr nz,_label_09_039	; $471b
_label_09_038:
	res 7,(hl)		; $471d
	ld e,$44		; $471f
	ld a,$01		; $4721
	ld (de),a		; $4723
	ld hl,$49c0		; $4724
	jp interactionSetScript		; $4727
_label_09_039:
	ld a,$03		; $472a
	ld (de),a		; $472c
	call clearAllParentItems		; $472d
	ld c,$28		; $4730
	call objectCheckLinkWithinDistance		; $4732
	sra a			; $4735
	ld e,$48		; $4737
	ld (de),a		; $4739
	ld b,a			; $473a
	...
	ld a,(de)		; $473c
	or a			; $473d
	jr nz,_label_09_040	; $473e
	ld a,b			; $4740
	add a			; $4741
	ld hl,$4825		; $4742
	rst_addDoubleIndex			; $4745
	jr _label_09_041		; $4746
_label_09_040:
	ld a,b			; $4748
	add a			; $4749
	ld hl,$4835		; $474a
	rst_addDoubleIndex			; $474d
_label_09_041:
	call $4813		; $474e
	ldi a,(hl)		; $4751
	ld c,$08		; $4752
	...
	ld a,(hl)		; $4757
	ld (de),a		; $4758
	call setLinkForceStateToState08		; $4759
	ld a,($cca4)		; $475c
	or $80			; $475f
	ld ($cca4),a		; $4761
	ld a,$04		; $4764
	call setScreenShakeCounter		; $4766
	ld a,$6c		; $4769
	jp playSound		; $476b
	call $47fa		; $476e
	ld e,$61		; $4771
	...
	res 7,(hl)		; $4799
	ret			; $479b
	call interactionDecCounter1		; $479c
	ret nz			; $479f
	ld l,$7a		; $47a0
	ld a,($cc33)		; $47a2
	xor (hl)		; $47a5
	...
	ld a,$01		; $47c7
	ld (de),a		; $47c9
	call interactionInitGraphics		; $47ca
	ld e,$56		; $47cd
	ld a,(de)		; $47cf
	ld h,d			; $47d0
	ld l,$49		; $47d1
	...
	ld a,(de)		; $47e0
	cp (hl)			; $47e1
	jr z,_label_09_042	; $47e2
	ld a,(hl)		; $47e4
	ld (de),a		; $47e5
	swap a			; $47e6
	rlca			; $47e8
	add $02			; $47e9
	call interactionSetAnimation		; $47eb
_label_09_042:
	ld e,$56		; $47ee
	ld a,(de)		; $47f0
	ld h,a			; $47f1
...
interactionCode7e:
	...
	ld a,($cc55)		; $487b
	ld hl,$491c		; $487e
	rst_addDoubleIndex			; $4881
	ld c,(hl)		; $4882
	ld a,($cc49)		; $4883
	ld hl,flagLocationGroupTable		; $4886
	rst_addAToHl			; $4889
	ld h,(hl)		; $488a
	ld l,c			; $488b
	ld a,(hl)		; $488c
	and $80			; $488d
	jp z,interactionDelete		; $488f
	ld c,$57		; $4892
	call objectSetShortPosition		; $4894
...
_label_09_043:
	...
	ld a,($d001)		; $48b4
	or a			; $48b7
	call z,checkLinkCollisionsEnabled		; $48b8
	ret nc			; $48bb
	call resetLinkInvincibility		; $48bc
	ld a,$03		; $48bf
	ld e,$44		; $48c1
	ld (de),a		; $48c3
	ld ($cca6),a		; $48c4
	...
	ld e,$46		; $48c9
	ld (de),a		; $48cb
	call setLinkForceStateToState08		; $48cc
	ld hl,$d01a		; $48cf
	ld (hl),$82		; $48d2
	call objectCopyPosition		; $48d4
	ld a,$01		; $48d7
	ld ($cca4),a		; $48d9
	ld a,$8d		; $48dc
	jp playSound		; $48de
	...
	ret			; $48ed
	ld hl,$d000		; $48ee
	call objectCopyPosition		; $48f1
	call $492e		; $48f4
	ret nz			; $48f7
	ld a,($cc55)		; $48f8
	ld hl,$491c		; $48fb
	rst_addDoubleIndex			; $48fe
	ldi a,(hl)		; $48ff
	ld c,(hl)		; $4900
	ld b,a			; $4901
	ld hl,$cc63		; $4902
...
_label_09_044:
	...
	or a			; $4937
	ret nz			; $4938
	ld a,(wFrameCounter)		; $4939
	and $03			; $493c
	jr nz,_label_09_045	; $493e
	ld hl,$d008		; $4940
	ld a,(hl)		; $4943
	inc a			; $4944
	and $03			; $4945
	ld (hl),a		; $4947
_label_09_045:
	jp interactionDecCounter1		; $4948
	ld e,$44		; $494b
	ld a,(de)		; $494d
	rst_jumpTable			; $494e
	ld d,a			; $494f
...
interactionCode7f:
	...
	dec d			; $49d5
	ld a,$04		; $49d6
	call objectSetCollideRadius		; $49d8
	ld bc,$7f01		; $49db
	call objectCreateInteraction		; $49de
	call getThisRoomFlags		; $49e1
	and $20			; $49e4
	jp nz,interactionDelete		; $49e6
	ld hl,$d140		; $49e9
	ld b,$40		; $49ec
	call clearMemory		; $49ee
	ld hl,$d140		; $49f1
	ld (hl),$81		; $49f4
	inc l			; $49f6
	ld (hl),$7f		; $49f7
	inc l			; $49f9
	ld (hl),$02		; $49fa
	call objectCopyPosition		; $49fc
	ld l,$56		; $49ff
	ldh a,(<hActiveObjectType)	; $4a01
	ldi (hl),a		; $4a03
	ldh a,(<hActiveObject)	; $4a04
	ld (hl),a		; $4a06
	ld h,d			; $4a07
	ld l,$4f		; $4a08
	ld (hl),$f0		; $4a0a
	...
	ld (de),a		; $4a22
	ld a,(hl)		; $4a23
	call interactionSetAnimation		; $4a24
	jp objectSetVisible81		; $4a27
	inc d			; $4a2a
	nop			; $4a2b
	ld (bc),a		; $4a2c
	stop			; $4a2d
	ld bc,loadGfxHeader		; $4a2e
	dec b			; $4a31
	ld bc,$040a		; $4a32
	ld (bc),a		; $4a35
	ld d,$05		; $4a36
	...
	ret nz			; $4a62
	ld b,$04		; $4a63
	call objectCheckCenteredWithLink		; $4a65
	ret nc			; $4a68
	ld c,$14		; $4a69
	call objectCheckLinkWithinDistance		; $4a6b
	ret nc			; $4a6e
	cp $04			; $4a6f
	ret nz			; $4a71
	call clearAllParentItems		; $4a72
	ld a,$81		; $4a75
	ld ($cca4),a		; $4a77
	ld ($cbca),a		; $4a7a
	ld hl,$d008		; $4a7d
	...
	call objectCheckCollidedWithLink_ignoreZ		; $4ab6
	ret nc			; $4ab9
	ld e,$67		; $4aba
	ld a,$06		; $4abc
	ld (de),a		; $4abe
	jp interactionIncState		; $4abf
	ld c,$08		; $4ac2
...
_label_09_047:
	...
	ld l,$46		; $4ace
	ld (hl),$1e		; $4ad0
	jp interactionIncState		; $4ad2
	call interactionDecCounter1		; $4ad5
	ret nz			; $4ad8
	ld a,$04		; $4ad9
	ld ($cc6a),a		; $4adb
	ld a,$01		; $4ade
	ld ($cc6b),a		; $4ae0
	call interactionIncState		; $4ae3
	ld a,($d00b)		; $4ae6
	sub $0e			; $4ae9
	ld l,$4b		; $4aeb
	ldi (hl),a		; $4aed
	...
	ld c,(hl)		; $4b00
	call showText		; $4b01
	call getThisRoomFlags		; $4b04
	set 5,(hl)		; $4b07
	ld e,$43		; $4b09
	ld a,(de)		; $4b0b
	ld c,a			; $4b0c
	ld a,$40		; $4b0d
	jp giveTreasure		; $4b0f
	ld c,$0f		; $4b12
	stop			; $4b14
	ld de,$1312		; $4b15
	inc d			; $4b18
	dec d			; $4b19
	call retIfTextIsActive		; $4b1a
	call interactionIncState		; $4b1d
	ld hl,$49cc		; $4b20
	jp interactionSetScript		; $4b23
	call interactionRunScript		; $4b26
	ret nc			; $4b29
	call interactionIncState		; $4b2a
	ld l,$46		; $4b2d
	ld (hl),$1e		; $4b2f
	call interactionDecCounter1		; $4b31
	ret nz			; $4b34
	ld l,$43		; $4b35
	ld a,(hl)		; $4b37
	add a			; $4b38
	ld hl,$4b59		; $4b39
	rst_addDoubleIndex			; $4b3c
	ldi a,(hl)		; $4b3d
	ld ($cc63),a		; $4b3e
	ldi a,(hl)		; $4b41
	ld ($cc64),a		; $4b42
	...
	ld ($cc67),a		; $4b4f
	xor a			; $4b52
	ld (wActiveMusic),a		; $4b53
	jp clearStaticObjects		; $4b56
	add b			; $4b59
	sub (hl)		; $4b5a
	ld b,h			; $4b5b
	ld bc,$8d80		; $4b5c
	...
	ld bc,$b9cd		; $4b78
	inc hl			; $4b7b
	jp nz,objectPreventLinkFromPassing		; $4b7c
	ld a,$01		; $4b7f
	ld (de),a		; $4b81
	ld bc,$060a		; $4b82
	call objectSetCollideRadii		; $4b85
	call objectGetTileAtPosition		; $4b88
	dec h			; $4b8b
	ld (hl),$0f		; $4b8c
	ld a,($cc55)		; $4b8e
	cp $06			; $4b91
	jr nz,_label_09_048	; $4b93
	ld hl,$ce24		; $4b95
	ld (hl),$05		; $4b98
	inc l			; $4b9a
	ld (hl),$0a		; $4b9b
_label_09_048:
	call interactionInitGraphics		; $4b9d
	jp objectSetVisible83		; $4ba0
	call checkInteractionState		; $4ba3
	jr nz,_label_09_049	; $4ba6
	ld a,$01		; $4ba8
	ld (de),a		; $4baa
	call interactionInitGraphics		; $4bab
