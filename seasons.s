...
+++
	...
	ld a,(hl)		; $403e
	or a			; $403f
	jr z,_label_10_003	; $4040
	ld l,$eb		; $4042
	ld a,(hl)		; $4044
	or a			; $4045
	jr z,_label_10_002	; $4046
	rlca			; $4048
	jr nc,_label_10_001	; $4049
	inc (hl)		; $404b
	jr _label_10_002		; $404c
_label_10_001:
	dec (hl)		; $404e
_label_10_002:
	dec l			; $404f
	bit 7,(hl)		; $4050
	jr nz,_label_10_004	; $4052
	dec l			; $4054
	ld a,(hl)		; $4055
	or a			; $4056
	jr z,_label_10_005	; $4057
	ld c,$00		; $4059
	ret			; $405b
_label_10_003:
	ld hl,$43c9		; $405c
	ld e,$3f		; $405f
	call interBankCall		; $4061
	ld e,$fe		; $4064
	ld a,$08		; $4066
	ld (de),a		; $4068
	ld c,$00		; $4069
...
updateParts:
	...
	ld a,($cd00)		; $61e0
	cp $08			; $61e3
	jr z,_label_10_244	; $61e5
	ld a,($cba0)		; $61e7
	or a			; $61ea
	jr nz,_label_10_244	; $61eb
	ld a,($cca4)		; $61ed
	and $88			; $61f0
	jr nz,_label_10_244	; $61f2
	ld d,$d0		; $61f4
	ld a,d			; $61f6
_label_10_248:
	ldh (<hActiveObject),a	; $61f7
	ld e,$c0		; $61f9
	ld a,(de)		; $61fb
	or a			; $61fc
	jr z,_label_10_249	; $61fd
	call $620e		; $61ff
	ld h,d			; $6202
	ld l,$ea		; $6203
	res 7,(hl)		; $6205
